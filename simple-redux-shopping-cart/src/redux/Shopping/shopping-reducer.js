import * as actinTypes from './shopping-types'
...
const shopReducer = (state = INITIAL_STATE, action) => {
    switch (action.type) {
        ...
        case actinTypes.REMOVE_FROM_CART:
            return {
                ...state,
                cart: state.cart.filter(item => item.id !== action.payload.id)
            }
        case actinTypes.ADJUST_QTY:
            return {
                ...state,
        ...
        case actinTypes.LOAD_CURRENT_ITEM:
            return {
                ...state,
